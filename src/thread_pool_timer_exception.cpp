 ...
 * under the License.
 */
#ifndef _THREAD_POOL_TIMER_EXCEPTION_SOURCE_
#define _THREAD_POOL_TIMER_EXCEPTION_SOURCE_
...
ThreadPoolTimerException::ThreadPoolTimerException( const char *msg ) :
